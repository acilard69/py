...
#ANTIJS_V2
cl = LineClient()
#cl = LineClient(authToken='EBuOHD09mN9hqFzGSWee.AltKXTBUYBGeh60GNXpmtG.2OlEF0Tu9Ylsysn9u3fjuEJEcDZb6Ym+/gms2ELO+FU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EBxcrX31UvWrDMaIuDp0.N1YzmHGZS9laIybLyoPWia.pqiA+jDeK9cuIVvUjA83aLB31DfC2uxdiAMw9qO5wTA=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EBPcRMneQCP6eLT9CA17.ZlT+fNMv/vMouHsAtXUf1W.EU3TgD/3VAnQWBeozZkSYJq9tvNam2EqbkKWkWCEgWo=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EB2oi5mByW3OTzmnmzA4.x2Dktd4MVxTFW2wnz9FIfa.P1ebat1wGexrND/RKRHXxatn6R3MNA2Mzc6HSQHMTNU=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EB5wn9mxBV0lCgHzIQn6.bD8cinQqLxJTwUvM/URazG.O0icUAf/9lHhBdUlrWjWiyaXIjADXHIIFTOTDU37y1Q=')
...
poll = LinePoll(cl)
call = cl
creator = ["u68b4e4c6d6eec9b8041fad209f13cc4e","u72354ff57b0814ed99881453d31c7fb0"]
owner = ["u68b4e4c6d6eec9b8041fad209f13cc4e","u72354ff57b0814ed99881453d31c7fb0"]
admin = ["u68b4e4c6d6eec9b8041fad209f13cc4e","u72354ff57b0814ed99881453d31c7fb0","u3aa43625b9af957658cd3f8389882980"]
staff = ["u68b4e4c6d6eec9b8041fad209f13cc4e","u72354ff57b0814ed99881453d31c7fb0","u3aa43625b9af957658cd3f8389882980"]
            ...
            try:
                ...
                if op.param3 in Zmid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.inviteIntoGroup(op.param1,[Zmid])
                        cl.sendMessage(op.param1,"=JAVXXX Invited=")
                    else:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        cl.findAndAddContactsByMid(op.param3)
                        cl.inviteIntoGroup(op.param1,[Zmid])
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot javxxx")
#ADD STAFF
                 if msg._from in admin:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot Linepy") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❧JAVXXX  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❧JAVXXX admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 xxx" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                for s in stream:
                                    ...
                                    rating = '\n⏩Rating : ' + str(vid.rating)
                                    deskripsi = '\n⏩Deskripsi : ' + str(vid.description)
                                cl.sendText(msg.to,"prosess tunggu 1 menit ...")
                                cl.sendText(msg.to,"Tunggu sampai lagu nya muncul ya kak:)\n baru command lagi")
                                cl.sendAudioWithURL(msg.to, shi)
                            except Exception as e:
                                cl.sendText(msg.to,str(e))

                        elif "profileig: " in msg.text:
                            cari = msg.text.replace("profileig: ","")                            
                            try:
                                website = uReq.get("https://www.instagram.com/"+cari+"/")
                                ...
                                for getInfoInstagram in data.findAll("script", {"type":"text/javascript"})[3]:
                                    ...
                                    for i in data["entry_data"]["ProfilePage"]:
                                        username = str(i["graphql"]["user"]["username"])
                                        name = str(i["graphql"]["user"]["full_name"])
                                        picture = str(i["graphql"]["user"]["profile_pic_url_hd"])
                                        biography = str(i["graphql"]["user"]["biography"])
                                        followers = str(i["graphql"]["user"]["edge_followed_by"]["count"])
                                        following = str(i["graphql"]["user"]["edge_follow"]["count"])
                                        private = str(i["graphql"]["user"]["is_private"])
                                        media = str(i["graphql"]["user"]["edge_owner_to_timeline_media"]["count"])
                                        ret_ = "╔═❂[  My Instagram Profile ]"
                                        ret_ += "\n╠☆☞ Username : " + username
                                        ret_ += "\n╠☆☞ Nama : " + name
                                        ret_ += "\n╠☆☞ Bio : " + biography
                                        ret_ += "\n╠☆☞ Pengikut : " + followers
...
#===========Protection============#
                        ...
                        elif 'Pro on ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Pro on ','')
                              if spl == 'on':
